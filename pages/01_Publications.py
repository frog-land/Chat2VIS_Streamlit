...
st.markdown('</a>Maddigan, P. <a style="text-align: center;padding-top: 0rem;" href="https://medium.com/@paula_m/can-google-gemini-small-language-models-and-gpt-4-turbo-generate-data-visualisations-from-natural-df84819b4a4b">Can Google Gemini, Small Language Models, and GPT-4 Turbo Generate Data Visualisations from Natural Language Text? </a>', unsafe_allow_html=True)
